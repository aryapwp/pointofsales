...
public partial class PointofSales {
    ...
    /// soOrderView
    /// </summary>
    public static SoOrderView soOrderView
    {
        get => HttpData.Get<SoOrderView>("soOrderView")!;
        set => HttpData["soOrderView"] = value;
    }

    /// <summary>
    /// Page class for so_order
    /// </summary>
    public class SoOrderView : SoOrderViewBase
    {
        // Constructor
        public SoOrderView(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SoOrderView() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SoOrderViewBase : SoOrder
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "soOrderView";
        ...
        public SoOrderViewBase()
        {
            ...
            if (IsApi()) {
                ...
                if (keys.Length > 0)
                    RecordKeys["SO_ORDER_ID"] = keys[0];
            } else {
                RecordKeys["SO_ORDER_ID"] = RouteValues.TryGetValue("SO_ORDER_ID", out obj) && obj != null ? UrlDecode(obj) : Get("SO_ORDER_ID"); // DN
            }
        ...
        // Page name
        public string PageName => "SoOrderView";
        ...
        // Constructor
        public SoOrderViewBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (RouteValues.TryGetValue("SO_ORDER_ID", out v) && !Empty(v)) { // DN
                SO_ORDER_ID.QueryValue = UrlDecode(v); // DN
                RecordKeys["SO_ORDER_ID"] = SO_ORDER_ID.QueryValue;
            } else if (Get("SO_ORDER_ID", out sv)) {
                SO_ORDER_ID.QueryValue = sv.ToString();
                RecordKeys["SO_ORDER_ID"] = SO_ORDER_ID.QueryValue;
            } else if (IsApi() && !Empty(keyValues)) {
                SO_ORDER_ID.QueryValue = ConvertToString(keyValues[0]);
                RecordKeys["SO_ORDER_ID"] = SO_ORDER_ID.QueryValue;
            } else if (!loadCurrentRecord) {
                returnUrl = "SoOrderList"; // Return to list
            }
                ...
                case "show": // Get a record to display
                        ...
                        if (!res) { // Load record based on key
                            ...
                            if (IsApi()) {
                                ...
                                return Terminate("SoOrderList"); // Return to list page
                            }
                        }
                    break;
            }
