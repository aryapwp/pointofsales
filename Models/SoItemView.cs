...
public partial class PointofSales {
    ...
    /// soItemView
    /// </summary>
    public static SoItemView soItemView
    {
        get => HttpData.Get<SoItemView>("soItemView")!;
        set => HttpData["soItemView"] = value;
    }

    /// <summary>
    /// Page class for so_item
    /// </summary>
    public class SoItemView : SoItemViewBase
    {
        // Constructor
        public SoItemView(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SoItemView() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SoItemViewBase : SoItem
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "soItemView";
        ...
        public SoItemViewBase()
        {
            ...
            if (IsApi()) {
                ...
                if (keys.Length > 0)
                    RecordKeys["SO_ITEM_ID"] = keys[0];
            } else {
                RecordKeys["SO_ITEM_ID"] = RouteValues.TryGetValue("SO_ITEM_ID", out obj) && obj != null ? UrlDecode(obj) : Get("SO_ITEM_ID"); // DN
            }
        ...
        // Page name
        public string PageName => "SoItemView";
        ...
        // Constructor
        public SoItemViewBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (RouteValues.TryGetValue("SO_ITEM_ID", out v) && !Empty(v)) { // DN
                SO_ITEM_ID.QueryValue = UrlDecode(v); // DN
                RecordKeys["SO_ITEM_ID"] = SO_ITEM_ID.QueryValue;
            } else if (Get("SO_ITEM_ID", out sv)) {
                SO_ITEM_ID.QueryValue = sv.ToString();
                RecordKeys["SO_ITEM_ID"] = SO_ITEM_ID.QueryValue;
            } else if (IsApi() && !Empty(keyValues)) {
                SO_ITEM_ID.QueryValue = ConvertToString(keyValues[0]);
                RecordKeys["SO_ITEM_ID"] = SO_ITEM_ID.QueryValue;
            } else if (!loadCurrentRecord) {
                returnUrl = "SoItemList"; // Return to list
            }
                ...
                case "show": // Get a record to display
                        ...
                        if (!res) { // Load record based on key
                            ...
                            if (IsApi()) {
                                ...
                                return Terminate("SoItemList"); // Return to list page
                            }
                        }
                    break;
            }
