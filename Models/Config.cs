...
public partial class PointofSales {
    ...
    public static partial class Config
    {
        ...
        public const string ProjectClassName = "ASPNETMaker2024.Models.PointofSales"; // DN
        ...
        public const string ProjectName = "PointofSales"; // Project name

        public static string ControllerName { get; set; } = "Home"; // Controller name // DN

        public const string ProjectId = "{C2008EF4-FC4B-4028-B6F7-41627F994A94}"; // Project ID (GUID)

        public static string RandomKey = "2dqhqexyreOfv1yR"; // Random key for encryption // DN

        public static string EncryptionKey = ""; // Encryption key for data protection

        public static string ProjectStylesheetFilename = "css/PointofSales.css"; // Project stylesheet file name (relative to wwwroot)
        ...
        public static string SidebarClass = "main-sidebar sidebar-dark-cyan"; // CSS class(es) for sidebar

        public static string NavbarClass = "main-header navbar navbar-expand navbar-cyan navbar-light border-bottom-0"; // CSS class(es) for navbar
        ...
        // Export Log
        public static string ExportPath = "export-c2008ef4-fc4b-4028-b6f7-41627f994a94"; // Export folder
        ...
        {
            {"com_customer", typeof(ComCustomer)},
            {"so_item", typeof(SoItem)},
            {"so_order", typeof(SoOrder)},
        };
