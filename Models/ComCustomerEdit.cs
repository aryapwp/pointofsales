...
public partial class PointofSales {
    ...
    /// comCustomerEdit
    /// </summary>
    public static ComCustomerEdit comCustomerEdit
    {
        get => HttpData.Get<ComCustomerEdit>("comCustomerEdit")!;
        set => HttpData["comCustomerEdit"] = value;
    }

    /// <summary>
    /// Page class for com_customer
    /// </summary>
    public class ComCustomerEdit : ComCustomerEditBase
    {
        // Constructor
        public ComCustomerEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public ComCustomerEdit() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class ComCustomerEditBase : ComCustomer
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "comCustomerEdit";
        ...
        // Page name
        public string PageName => "ComCustomerEdit";
        ...
        // Constructor
        public ComCustomerEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (IsApi()) {
                ...
                if (RouteValues.TryGetValue("COM_CUSTOMER_ID", out rv)) { // DN
                    COM_CUSTOMER_ID.FormValue = UrlDecode(rv); // DN
                    COM_CUSTOMER_ID.OldValue = COM_CUSTOMER_ID.FormValue;
                } else if (CurrentForm.HasValue("x_COM_CUSTOMER_ID")) {
                    COM_CUSTOMER_ID.FormValue = CurrentForm.GetValue("x_COM_CUSTOMER_ID");
                    COM_CUSTOMER_ID.OldValue = COM_CUSTOMER_ID.FormValue;
                } else if (!Empty(keyValues)) {
                    COM_CUSTOMER_ID.OldValue = ConvertToString(keyValues[0]);
                } else {
                ...
                if (!Empty(Post("action"))) {
                    ...
                    if (RouteValues.TryGetValue("COM_CUSTOMER_ID", out rv)) { // DN
                        COM_CUSTOMER_ID.QueryValue = UrlDecode(rv); // DN
                        loadByQuery = true;
                    } else if (Get("COM_CUSTOMER_ID", out sv)) {
                        COM_CUSTOMER_ID.QueryValue = sv.ToString();
                        loadByQuery = true;
                    } else {
                        COM_CUSTOMER_ID.CurrentValue = DbNullValue;
                    }
                }
        ...
        if (postBack) {
            ...
            if (IsApi() && RouteValues.TryGetValue("key", out object? k)) {
                ...
                COM_CUSTOMER_ID.FormValue = ConvertToString(keyValues[0]);
            }
        }
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("ComCustomerList"); // No matching record, return to list
                        }
                    break;
                case "update": // Update // DN
                    CloseRecordset(); // DN
                    string returnUrl = ReturnUrl;
                    if (GetPageName(returnUrl) == "ComCustomerList")
                    ...
                    if (res) { // Update record based on key
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "ComCustomerList") {
                                ...
                                returnUrl = "ComCustomerList"; // Return list page content
                            }
                        }
                        if (IsJsonResponse()) {
        ...
        protected async Task LoadFormValues() {
            ...
            if (!COM_CUSTOMER_ID.IsDetailKey)
                COM_CUSTOMER_ID.SetFormValue(val);
        ...
        protected async Task<bool> ValidateForm() {
            ...
            bool validateForm = true;
                ...
                if (CUSTOMER_NAME.Visible && CUSTOMER_NAME.Required) {
        ...
        {
            object? value;
            if (row.TryGetValue("CUSTOMER_NAME", out value)) // CUSTOMER_NAME
                CUSTOMER_NAME.CurrentValue = value;
        }
        ...
        protected void SetupBreadcrumb()
        {
            ...
            breadcrumb.Add("list", TableVar, AppPath(AddMasterUrl("ComCustomerList")), "", TableVar, true);
            string pageId = "edit";
