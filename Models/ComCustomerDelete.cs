...
public partial class PointofSales {
    ...
    /// comCustomerDelete
    /// </summary>
    public static ComCustomerDelete comCustomerDelete
    {
        get => HttpData.Get<ComCustomerDelete>("comCustomerDelete")!;
        set => HttpData["comCustomerDelete"] = value;
    }

    /// <summary>
    /// Page class for com_customer
    /// </summary>
    public class ComCustomerDelete : ComCustomerDeleteBase
    {
        // Constructor
        public ComCustomerDelete(Controller controller) : base(controller)
        {
        }

        // Constructor
        public ComCustomerDelete() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class ComCustomerDeleteBase : ComCustomer
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "comCustomerDelete";
        ...
        // Page name
        public string PageName => "ComCustomerDelete";
        ...
        // Constructor
        public ComCustomerDeleteBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (Empty(filter))
                return Terminate("ComCustomerList"); // Prevent SQL injection, return to List page
            ...
            if (IsShow) { // Load records for display // DN
                ...
                if (TotalRecords <= 0) { // No record found, exit
                    CloseRecordset(); // DN
                    return Terminate("ComCustomerList"); // Return to list
                }
            }
