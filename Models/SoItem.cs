...
public partial class PointofSales {
    ...
    /// </summary>
    [MaybeNull]
    public static SoItem soItem
    {
        get => HttpData.Resolve<SoItem>("so_item");
        set => HttpData["so_item"] = value;
    }

    /// <summary>
    /// Table class for so_item
    /// </summary>
    public class SoItem : DbTable
    {
        ...
        public readonly DbField<MySqlDbType> SO_ITEM_ID;

        public readonly DbField<MySqlDbType> SO_ORDER_ID;

        public readonly DbField<MySqlDbType> ITEM_NAME;

        public readonly DbField<MySqlDbType> QUANTITY;

        public readonly DbField<MySqlDbType> PRICE;
        ...
        public SoItem()
        {
            ...
            Name = "so_item";
            Type = "TABLE";
            UpdateTable = "so_item"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            // SO_ITEM_ID
            SO_ITEM_ID = new(this, "x_SO_ITEM_ID", 20, MySqlDbType.Int64) {
                Name = "SO_ITEM_ID",
                Expression = "`SO_ITEM_ID`",
                BasicSearchExpression = "`SO_ITEM_ID`",
                DateTimeFormat = -1,
                VirtualExpression = "`SO_ITEM_ID`",
                IsVirtual = false,
                ...
                CustomMessage = Language.FieldPhrase("so_item", "SO_ITEM_ID", "CustomMsg"),
                IsUpload = false
            };
            SO_ITEM_ID.Raw = true;
            Fields.Add("SO_ITEM_ID", SO_ITEM_ID);
            ...
            SO_ORDER_ID = new(this, "x_SO_ORDER_ID", 20, MySqlDbType.Int64) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN"],
                CustomMessage = Language.FieldPhrase("so_item", "SO_ORDER_ID", "CustomMsg"),
                IsUpload = false
            };
            ...
            // ITEM_NAME
            ITEM_NAME = new(this, "x_ITEM_NAME", 200, MySqlDbType.VarString) {
                Name = "ITEM_NAME",
                Expression = "`ITEM_NAME`",
                UseBasicSearch = true,
                BasicSearchExpression = "`ITEM_NAME`",
                DateTimeFormat = -1,
                VirtualExpression = "`ITEM_NAME`",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                CustomMessage = Language.FieldPhrase("so_item", "ITEM_NAME", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("ITEM_NAME", ITEM_NAME);

            // QUANTITY
            QUANTITY = new(this, "x_QUANTITY", 3, MySqlDbType.Int32) {
                Name = "QUANTITY",
                Expression = "`QUANTITY`",
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN"],
                CustomMessage = Language.FieldPhrase("so_item", "QUANTITY", "CustomMsg"),
                IsUpload = false
            };
            QUANTITY.Raw = true;
            ...
            // PRICE
            PRICE = new(this, "x_PRICE", 4, MySqlDbType.Float) {
                Name = "PRICE",
                Expression = "`PRICE`",
                ...
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN"],
                CustomMessage = Language.FieldPhrase("so_item", "PRICE", "CustomMsg"),
                IsUpload = false
            };
            PRICE.Raw = true;
        ...
        public async Task<int> InsertAsync(object data)
        {
            ...
            if (data is IDictionary<string, object> d)
                ...
                throw new ArgumentException("Data must be of anonymous or Dictionary<string, object> or Entities.SoItem type", "data");
            row = row.Where(kvp => {
            ...
            try {
                ...
                if (row.ContainsKey("SO_ITEM_ID"))
                    row["SO_ITEM_ID"] = lastInsertedId;
                else
                    row.Add("SO_ITEM_ID", lastInsertedId);
                SO_ITEM_ID.SetDbValue(lastInsertedId);
                result = 1;
            } catch (Exception e) {
        ...
        public void LoadDbValues(Dictionary<string, object>? row)
        {
            if (row == null)
                return;
            try {
                SO_ITEM_ID.DbValue = row["SO_ITEM_ID"]; // Set DB value only
                SO_ORDER_ID.DbValue = row["SO_ORDER_ID"]; // Set DB value only
                ITEM_NAME.DbValue = row["ITEM_NAME"]; // Set DB value only
        ...
        private string _sqlKeyFilter => "`SO_ITEM_ID` = @SO_ITEM_ID@";
        ...
        public string GetModalCaption(string pageName)
        {
            return pageName switch {
                "SoItemView" => Language.Phrase("View"),
                "SoItemEdit" => Language.Phrase("Edit"),
                "SoItemAdd" => Language.Phrase("Add"),
                _ => String.Empty
            };
        }
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "SoItemView",
                Config.ApiAddAction => "SoItemAdd",
                Config.ApiEditAction => "SoItemEdit",
                Config.ApiDeleteAction => "SoItemDelete",
                Config.ApiListAction => "SoItemList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "SoItemList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("SoItemView", parm);
            else
                url = KeyUrl("SoItemView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "SoItemAdd";
        ...
        {
            string url = "";
            url = KeyUrl("SoItemEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("SoItemList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("SoItemAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("SoItemList", "action=copy"))); // DN
        ...
        public string GetDeleteUrl(string parm = "")
        {
            return UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
                ...
                : AppPath(KeyUrl("SoItemDelete", parm)); // DN
        }
        ...
        {
            string json = "";
            json += "\"SO_ITEM_ID\":" + ConvertToJson(SO_ITEM_ID.CurrentValue, "number", true);
            json = "{" + json + "}";
            if (htmlEncode)
        ...
        {
            if (!IsNull(SO_ITEM_ID.CurrentValue)) {
                url += "/" + SO_ITEM_ID.CurrentValue;
            } else {
        ...
        public List<string> GetRecordKeys()
        {
            ...
            if (Post("key_m[]", out sv) || Get("key_m[]", out sv)) { // DN
                ...
                if (RouteValues.TryGetValue("SO_ITEM_ID", out object? v0)) { // SO_ITEM_ID // DN
                    key = UrlDecode(v0); // DN
                } else if (IsApi() && !Empty(keyValues)) {
                    key = keyValues[0];
                } else {
                    key = Param("SO_ITEM_ID");
                }
                keysList.Add(key);
            }
            // Check keys
        ...
        public string GetFilterFromRecordKeys(bool setCurrent = true)
        {
            ...
            foreach (var keys in recordKeys) {
                if (!Empty(keyFilter))
                    keyFilter += " OR ";
                if (setCurrent)
                    SO_ITEM_ID.CurrentValue = keys;
                else
                    SO_ITEM_ID.OldValue = keys;
        ...
        public async Task RenderEditRow()
        {
            ...
            // SO_ITEM_ID
            SO_ITEM_ID.SetupEditAttributes();
            SO_ITEM_ID.EditValue = SO_ITEM_ID.CurrentValue;
            SO_ITEM_ID.ViewCustomAttributes = "";
            ...
            ITEM_NAME.EditValue = ITEM_NAME.CurrentValue;
        ...
        public async Task ExportDocument(dynamic doc, DbDataReader dataReader, int startRec, int stopRec, string exportType = "")
        {
            ...
            if (!doc.ExportCustom) {
                ...
                if (doc.Horizontal) { // Horizontal format, write header
                    doc.BeginExportRow();
                    if (exportType == "view") {
                        doc.ExportCaption(SO_ITEM_ID);
                        doc.ExportCaption(SO_ORDER_ID);
                        doc.ExportCaption(ITEM_NAME);
            ...
            do { // DN
                ...
                if (recCnt >= startRec) {
                    ...
                    if (!doc.ExportCustom) {
                        ...
                        if (exportType == "view") {
                            await doc.ExportField(SO_ITEM_ID);
                            await doc.ExportField(SO_ORDER_ID);
                            await doc.ExportField(ITEM_NAME);
