...
public partial class PointofSales {
    ...
    /// soOrderDelete
    /// </summary>
    public static SoOrderDelete soOrderDelete
    {
        get => HttpData.Get<SoOrderDelete>("soOrderDelete")!;
        set => HttpData["soOrderDelete"] = value;
    }

    /// <summary>
    /// Page class for so_order
    /// </summary>
    public class SoOrderDelete : SoOrderDeleteBase
    {
        // Constructor
        public SoOrderDelete(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SoOrderDelete() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SoOrderDeleteBase : SoOrder
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "soOrderDelete";
        ...
        // Page name
        public string PageName => "SoOrderDelete";
        ...
        // Constructor
        public SoOrderDeleteBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (Empty(filter))
                return Terminate("SoOrderList"); // Prevent SQL injection, return to List page
            ...
            if (IsShow) { // Load records for display // DN
                ...
                if (TotalRecords <= 0) { // No record found, exit
                    CloseRecordset(); // DN
                    return Terminate("SoOrderList"); // Return to list
                }
            }
