...
public partial class PointofSales {
    ...
    /// soItemDelete
    /// </summary>
    public static SoItemDelete soItemDelete
    {
        get => HttpData.Get<SoItemDelete>("soItemDelete")!;
        set => HttpData["soItemDelete"] = value;
    }

    /// <summary>
    /// Page class for so_item
    /// </summary>
    public class SoItemDelete : SoItemDeleteBase
    {
        // Constructor
        public SoItemDelete(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SoItemDelete() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SoItemDeleteBase : SoItem
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "soItemDelete";
        ...
        // Page name
        public string PageName => "SoItemDelete";
        ...
        // Constructor
        public SoItemDeleteBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (Empty(filter))
                return Terminate("SoItemList"); // Prevent SQL injection, return to List page
            ...
            if (IsShow) { // Load records for display // DN
                ...
                if (TotalRecords <= 0) { // No record found, exit
                    CloseRecordset(); // DN
                    return Terminate("SoItemList"); // Return to list
                }
            }
