...
public partial class PointofSales {
    ...
    /// soItemEdit
    /// </summary>
    public static SoItemEdit soItemEdit
    {
        get => HttpData.Get<SoItemEdit>("soItemEdit")!;
        set => HttpData["soItemEdit"] = value;
    }

    /// <summary>
    /// Page class for so_item
    /// </summary>
    public class SoItemEdit : SoItemEditBase
    {
        // Constructor
        public SoItemEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SoItemEdit() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SoItemEditBase : SoItem
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "soItemEdit";
        ...
        // Page name
        public string PageName => "SoItemEdit";
        ...
        // Constructor
        public SoItemEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (IsApi()) {
                ...
                if (RouteValues.TryGetValue("SO_ITEM_ID", out rv)) { // DN
                    SO_ITEM_ID.FormValue = UrlDecode(rv); // DN
                    SO_ITEM_ID.OldValue = SO_ITEM_ID.FormValue;
                } else if (CurrentForm.HasValue("x_SO_ITEM_ID")) {
                    SO_ITEM_ID.FormValue = CurrentForm.GetValue("x_SO_ITEM_ID");
                    SO_ITEM_ID.OldValue = SO_ITEM_ID.FormValue;
                } else if (!Empty(keyValues)) {
                    SO_ITEM_ID.OldValue = ConvertToString(keyValues[0]);
                } else {
                ...
                if (!Empty(Post("action"))) {
                    ...
                    if (RouteValues.TryGetValue("SO_ITEM_ID", out rv)) { // DN
                        ...
                        SO_ITEM_ID.CurrentValue = DbNullValue;
                    }
                }
        ...
        if (postBack) {
            ...
            if (IsApi() && RouteValues.TryGetValue("key", out object? k)) {
                ...
                SO_ITEM_ID.FormValue = ConvertToString(keyValues[0]);
            }
        }
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("SoItemList"); // No matching record, return to list
                        }
                    break;
        ...
        protected async Task LoadFormValues() {
            ...
            if (!SO_ITEM_ID.IsDetailKey)
                SO_ITEM_ID.SetFormValue(val);
        ...
        {
            SO_ITEM_ID.CurrentValue = SO_ITEM_ID.FormValue;
        ...
        protected async Task<bool> ValidateForm() {
            ...
            bool validateForm = true;
                if (SO_ITEM_ID.Visible && SO_ITEM_ID.Required) {
                    if (!SO_ITEM_ID.IsDetailKey && Empty(SO_ITEM_ID.FormValue)) {
                        SO_ITEM_ID.AddErrorMessage(ConvertToString(SO_ITEM_ID.RequiredErrorMessage).Replace("%s", SO_ITEM_ID.Caption));
                    }
                }
        ...
        protected Dictionary<string, object> GetEditRow(Dictionary<string, object> rsold)
        {
            ...
            // SO_ORDER_ID
            SO_ORDER_ID.SetDbValue(rsnew, SO_ORDER_ID.CurrentValue, SO_ORDER_ID.ReadOnly);

            // ITEM_NAME
            ITEM_NAME.SetDbValue(rsnew, ITEM_NAME.CurrentValue, ITEM_NAME.ReadOnly);
        ...
        protected void RestoreEditFormFromRow(Dictionary<string, object> row)
        {
            ...
            if (row.TryGetValue("SO_ORDER_ID", out value)) // SO_ORDER_ID
                SO_ORDER_ID.CurrentValue = value;
            if (row.TryGetValue("ITEM_NAME", out value)) // ITEM_NAME
                ITEM_NAME.CurrentValue = value;
