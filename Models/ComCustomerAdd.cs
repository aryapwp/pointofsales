...
public partial class PointofSales {
    ...
    /// comCustomerAdd
    /// </summary>
    public static ComCustomerAdd comCustomerAdd
    {
        get => HttpData.Get<ComCustomerAdd>("comCustomerAdd")!;
        set => HttpData["comCustomerAdd"] = value;
    }

    /// <summary>
    /// Page class for com_customer
    /// </summary>
    public class ComCustomerAdd : ComCustomerAddBase
    {
        // Constructor
        public ComCustomerAdd(Controller controller) : base(controller)
        {
        }

        // Constructor
        public ComCustomerAdd() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class ComCustomerAddBase : ComCustomer
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "comCustomerAdd";
        ...
        // Page name
        public string PageName => "ComCustomerAdd";
        ...
        // Constructor
        public ComCustomerAddBase(Controller? controller = null): this() { // DN
            if (controller != null)
            ...
            switch (CurrentAction) {
                case "copy": // Copy an existing record
                    if (rsold == null) { // Record not loaded
                        ...
                        return Terminate("ComCustomerList"); // No matching record, return to List page // DN
                    }
                    break;
                case "insert": // Add new record // DN
                    ...
                    if (res) { // Add successful
                        ...
                        else if (GetPageName(returnUrl) == "ComCustomerView")
        ...
        protected async Task<JsonBoolResult> AddRow(Dictionary<string, object>? rsold = null) { // DN
            ...
            if (insertRow) {
                try {
                    ...
                    rsnew["COM_CUSTOMER_ID"] = COM_CUSTOMER_ID.CurrentValue!;
                } catch (Exception e) {
                    if (Config.Debug)
                        throw;
        ...
        private void RestoreAddFormFromRow(Dictionary<string, object> row)
        {
            ...
            if (row.TryGetValue("CUSTOMER_NAME", out value)) // CUSTOMER_NAME
                CUSTOMER_NAME.SetFormValue(ConvertToString(value));
        }
