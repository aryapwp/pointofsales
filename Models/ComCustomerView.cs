...
public partial class PointofSales {
    ...
    /// comCustomerView
    /// </summary>
    public static ComCustomerView comCustomerView
    {
        get => HttpData.Get<ComCustomerView>("comCustomerView")!;
        set => HttpData["comCustomerView"] = value;
    }

    /// <summary>
    /// Page class for com_customer
    /// </summary>
    public class ComCustomerView : ComCustomerViewBase
    {
        // Constructor
        public ComCustomerView(Controller controller) : base(controller)
        {
        }

        // Constructor
        public ComCustomerView() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class ComCustomerViewBase : ComCustomer
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "comCustomerView";
        ...
        public ComCustomerViewBase()
        {
            ...
            if (IsApi()) {
                ...
                if (keys.Length > 0)
                    RecordKeys["COM_CUSTOMER_ID"] = keys[0];
            } else {
                RecordKeys["COM_CUSTOMER_ID"] = RouteValues.TryGetValue("COM_CUSTOMER_ID", out obj) && obj != null ? UrlDecode(obj) : Get("COM_CUSTOMER_ID"); // DN
            }
        ...
        // Page name
        public string PageName => "ComCustomerView";
        ...
        // Constructor
        public ComCustomerViewBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (RouteValues.TryGetValue("COM_CUSTOMER_ID", out v) && !Empty(v)) { // DN
                COM_CUSTOMER_ID.QueryValue = UrlDecode(v); // DN
                RecordKeys["COM_CUSTOMER_ID"] = COM_CUSTOMER_ID.QueryValue;
            } else if (Get("COM_CUSTOMER_ID", out sv)) {
                COM_CUSTOMER_ID.QueryValue = sv.ToString();
                RecordKeys["COM_CUSTOMER_ID"] = COM_CUSTOMER_ID.QueryValue;
            } else if (IsApi() && !Empty(keyValues)) {
                COM_CUSTOMER_ID.QueryValue = ConvertToString(keyValues[0]);
                RecordKeys["COM_CUSTOMER_ID"] = COM_CUSTOMER_ID.QueryValue;
            } else if (!loadCurrentRecord) {
                returnUrl = "ComCustomerList"; // Return to list
            }
                ...
                case "show": // Get a record to display
                        ...
                        if (!res) { // Load record based on key
                            ...
                            if (IsApi()) {
                                ...
                                return Terminate("ComCustomerList"); // Return to list page
                            }
                        }
                    break;
            }
